...
const mains = [
  ...
  {
    category: "פילה בקר",
    description: "פילה בקר לצד פירה כמהין, באן אסאדו וקרם גזר פיקנטי",
  },
  {
    category: "מולארד",
    description: "חזה מולארד על מצע של קרם בטטה",
  },
  {
    category: "פרגית",
...
const cocktails = [
  {
    ...
    description:
      "וויסקי סקוטי, פרחי סמבוק, לימון וקציפת יין מתובל (מתובל | מתוק).",
  },
  {
    category: "טאקו מרגריטה",
    description:
      "טקילה אנייחו, טריפקל סק, מרטיני לבן, כוסברה, נקטר אגבה ופלפל שאטה (חרפרף | עשבוני | מרענן).",
  },
  {
    category: "גרייק גארדן",
    description:
      "ג'ין, ורמוט, אלדרפלאוור, מלפפון, מלח ולימון פרסי (מרענן | מתקתק | חמוץ).",
  },
  {
    category: "גזמין",
